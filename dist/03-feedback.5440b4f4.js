...
const updateLocalStorageThrottled = (0, _lodashThrottleDefault.default)(updateLocalStorage, 500);
...
function updateLocalStorage() {
    ...
    localStorage.setItem("feedback-form-state", JSON.stringify(feedbackForm2));
}
